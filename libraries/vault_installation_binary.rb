    ...
    class VaultInstallationBinary < Chef::Provider
      ...
      def self.binary_checksum(node, resource)
        ...
        when 'darwin-i386'
          ...
          when '0.10.3' then '2c56631bacfc995c12b338adeeecb00b0824d77297858b197be1306571bcb8f9'  
          end
        when 'darwin-amd64'
          case resource.version
          ...
          when '0.10.3' then 'c092bd4d279494daf801eee1905d693ec505fd274e0587c69a64354df66af426'  
          end
        when 'freebsd-i386'
          case resource.version
          ...
          when '0.10.3' then 'd844e78fe1ddc2163873d48bf06023883afebe4dd1d7dbc10441f6574b229943'  
          end
        when 'freebsd-amd64'
          case resource.version
          ...
          when '0.10.3' then '54ec77940abaf832955087bc03730c0835dbd4eec127d3393b90a274f7a04931'  
          end
        when 'freebsd-arm'
          case resource.version
          ...
          when '0.10.3' then '866c9b4932ac01acf8a708836cabbb0973a75bae7dcf603cdec80a200d7d390e'  
          end
        when 'linux-i386'
          case resource.version
          ...
          when '0.10.3' then '87cba10d831107f70cd3348f2041e460645154913300c7f9e85d9eda99ce4687'  
          end
        when 'linux-amd64'
          case resource.version
          ...
          when '0.10.3' then 'ffec1c201f819f47581f54c08653a8d17ec0a6699854ebd7f6625babb9e290ed'  
          end
        when 'linux-arm64'
          case resource.version
          when '0.10.3' then '9a493cce9ab501a324664b0ce659b5b8ec7666455e936f96709810c9d27a1903'
          end
        when 'linux-arm'
          case resource.version
          ...
          when '0.10.3' then '91f893bb34cd19890181278a655368dde898e532d3a381b26fab78ab3cce12ba'  
          end
        when 'windows-i386'
          case resource.version
          ...
          when '0.10.3' then 'f7711c82ae72a6e9e554233f45a63997dcde0648a5f6bb358607874993446419'  
          end
        when 'windows-amd64'
          case resource.version
          ...
          when '0.10.3' then '4dff8884a5d0113a8d7f75f5c1328ec69367385fdf651aab46dc67a6367533aa'  
          end
        end
      end
    end
